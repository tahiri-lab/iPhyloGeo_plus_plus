...
class Ui_LoadingDialog(object):
    def setupUi(self, LoadingDialog):
        ...
        self.loadingLabel = QtWidgets.QLabel(LoadingDialog)
        ...
        self.movieLabel = QtWidgets.QLabel(LoadingDialog)
        ...
        self.checkListWidget = QtWidgets.QListWidget(LoadingDialog)
