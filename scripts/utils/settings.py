...
class HoverLabel(QLabel):
    ...
    class Settings(object):
        def setupUi(self, Dialog):
            ...
            self.bootstrapValue = HoverLabel("Bootstrap threshold", "The higher the threshold, the more precise and more reliable the results are, but the workload will be longer", self.textEdit, HoverLabel.image_label,
