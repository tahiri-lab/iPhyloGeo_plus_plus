...
from PyQt5.QtWidgets import QFileDialog, QTabWidget, QWidget, QPushButton, QGraphicsDropShadowEffect
from PyQt5.QtWebEngineWidgets import QWebEngineView
...
class UiMainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        #self.geneticTreeButtonPage1.clicked.connect()
        #self.statisticsButtonPage1.clicked.connect(self.showGenDatPage)
        ...
        self.submitButtonPage4.clicked.connect(self.showFilteredResults)
